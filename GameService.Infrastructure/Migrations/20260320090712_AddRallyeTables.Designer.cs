...
namespace GameService.Infrastructure.Migrations
{
    ...
    [Migration("20260320090712_AddRallyeTables")]
    partial class AddRallyeTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameService.Infrastructure.Entities.GameEntity", b =>
                {
                    ...
                    b.Property<string>("HowLongToBeatName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<decimal?>("MainStoryAndExtraTime")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("MainStoryTime")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("GameService.Infrastructure.Entities.Rallye.RallyeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Rallye", "rallye");
                });

            modelBuilder.Entity("GameService.Infrastructure.Entities.Rallye.SpecialEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Special", "rallye");
                });

            modelBuilder.Entity("GameService.Infrastructure.Entities.Rallye.SpecialTimeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PlayerRallye", b =>
                {
                    b.Property<Guid>("PlayersId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RallyesId")
                        .HasColumnType("uuid");

                    b.HasKey("PlayersId", "RallyesId");

                    b.HasIndex("RallyesId");

                    b.ToTable("PlayerRallye", "rallye");
                });
            ...
            modelBuilder.Entity("GameService.Infrastructure.Entities.Rallye.SpecialEntity", b =>
                {
                    b.HasOne("GameService.Infrastructure.Entities.Rallye.RallyeEntity", "Rallye")
                        .WithMany("Specials")
                        .HasForeignKey("RallyeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameService.Infrastructure.Entities.Rallye.SpecialTimeEntity", b =>
                {
                    b.HasOne("GameService.Infrastructure.Entities.Rallye.PlayerEntity", "Player")
                        .WithMany("SpecialTimes")
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameService.Infrastructure.Entities.Rallye.SpecialEntity", "Special")
                        .WithMany("SpecialTimes")
            ...
            modelBuilder.Entity("PlayerRallye", b =>
                {
                    b.HasOne("GameService.Infrastructure.Entities.Rallye.PlayerEntity", null)
                        .WithMany()
                        .HasForeignKey("PlayersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameService.Infrastructure.Entities.Rallye.RallyeEntity", null)
                        .WithMany()
                        .HasForeignKey("RallyesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
