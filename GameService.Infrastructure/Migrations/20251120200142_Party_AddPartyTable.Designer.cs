...
namespace GameService.Infrastructure.Migrations
{
    ...
    [Migration("20251120200142_Party_AddPartyTable")]
    partial class Party_AddPartyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyTeam", b =>
                {
                    ...
                    b.HasKey("PartiesId", "TeamsId");

                    b.HasIndex("TeamsId");

                    b.ToTable("PartyTeam", "party");
                });
            ...
            modelBuilder.Entity("PartyTeam", b =>
                {
                    b.HasOne("GameService.Infrastructure.Entities.Party.PartyEntity", null)
                        .WithMany()
